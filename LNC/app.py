...
def page_2(page):
    ...
    web = 'https://cloud.tencent.com/developer/article/1429424'
    if request.method == 'POST' and 'tag' in request.form:
        ...
        if len(list) != 0:
            web = 'https://cloud.tencent.com/developer/article/1429424'
            return render_template('page_2.html', employees=employees, tag=tag, web=web)
        else:
    ...
    if request.method == 'POST' and 'age_min' and 'age_max' in request.form:
        ...
        web = 'https://cloud.tencent.com/developer/article/1429424'
        return render_template('page_2.html', employees=employees, age_min=age_min,age_max=age_max,web=web)
    return render_template('page_2.html', employees=employees,web=web)
